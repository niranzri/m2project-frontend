    ...
    <div className="mainCtn coverImageAbout"> 
        <div className={classes.aboutCtn}>
            <div className={classes.aboutText}>
                ...
                Our journey over the decades stands as a testament to our dedication to providing exceptional flight services. 
                At FlyZest, we soar above the rest, connecting people and places with Spanish warmth and reliability. 
                Your journey matters to us, and we are committed to making it memorable with FlyZest.</p>
